...
public class MechanismVisualizer {
    ...
    public void log(String key) {
        var turretPose = new Pose3d(RobotState.getInstance().getEstimatedPose())
                .transformBy(
                        new Transform3d(
                                new Translation3d(-0.5, 0.0, 0.35),
                                new Rotation3d(0.0, 0.0, turretAngle.getRadians())));
        var hoodPose = turretPose.transformBy(
                new Transform3d(
        ...
        var cameraPose = hoodPose.transformBy(
                new Transform3d(new Translation3d(-0.3, 0.0, 0.2), new Rotation3d(0.0, Units.degreesToRadians(-30), 0.0)));
